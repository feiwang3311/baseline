...
class slBuffer_oneFile(object):
    def __init__(self, size, fileNo):
        ...
        # data are taken out by step not by play!! TRICKY: SOLVE LATER. For now, let's just make mean_step as the mean of last import
    ...
    def add_from_Pi_structs(self, Pi_node):
        ...
        """
        # first let's update the mean_steps (FIXME: updates to the most recent play, not good?)
        self.mean_step = Pi_node.total_steps / Pi_node.repeat 
