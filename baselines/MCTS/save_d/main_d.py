...
def main():
    ...
    parser.add_argument('--save_dir', type = str, help='where is the model saved', default="GPO2/Test1")
    ...
    parser.add_argument('--nrepeat', type = int, help="how many times to repeat a SAT problem", default= 2)
